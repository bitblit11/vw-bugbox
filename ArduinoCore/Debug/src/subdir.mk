...
src/CDC.o: /opt/arduino/hardware/arduino/cores/arduino/CDC.cpp
	...
	avr-g++ -I/opt/arduino/hardware/arduino/cores/arduino -I/opt/arduino/hardware/arduino/variants/standard -Wall -g2 -gstabs -O0 -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -fno-exceptions -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
...
src/WInterrupts.o: /opt/arduino/hardware/arduino/cores/arduino/WInterrupts.c
	...
	avr-gcc -I/opt/arduino/hardware/arduino/variants/standard -Wall -g2 -gstabs -O0 -fpack-struct -fshort-enums -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
